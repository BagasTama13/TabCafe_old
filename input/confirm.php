...
if (isset($_GET['delete'])) {
    $id_pasien = mysqli_real_escape_string($koneksi, $_GET['delete']);
    ...
    if ($delete_query) {
        ...
        $error_message = "Error deleting record: " . mysqli_error($koneksi);
...
if (isset($_SESSION['show_delete_modal']) && $_SESSION['show_delete_modal']) {
    ...
    <!-- Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labellekoneksiy="deleteModalLabel" aria-hidden="true">
